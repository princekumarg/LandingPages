...
canvas2()
function canvas3() {
  const canvas = document.querySelector("#page15 >#left15>canvas");
  const context = canvas.getContext("2d");
...
document.querySelector("#page15>#right15>#right15con1>p").textContent.split("").forEach(function (dets) {
  clutter += `<span>${dets}</span>`

  document.querySelector("#page15>#right15>#right15con1>p").innerHTML = clutter;
})
